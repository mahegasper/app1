 ...
 def create
    ...
    if @setting.save
       redirect_to edit_admin_setting_url(@setting), notice: 'Successfully created setting'
        ...
        flash[:alert] = 'There was a problem craating setting'
        render :new
    end
  end
  ...
  def update
    ...
    if @setting.update(settings_params)
        redirect_to edit_admin_setting_url, notice: 'Setting was successfully updated'
    else
        flash[:alert] = 'There was a problem update settings'
        render :edit
    end
